  ...
  return (
    <div className="fixed inset-0 z-50 bg-black flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-base text-[#525252] tracking-wide">{message}</p>
      </div>
      ...
      <div className="absolute bottom-8 flex flex-col items-center gap-3">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <p className="text-sm text-[#737373] tracking-[0.15em] uppercase">
            Sistema Cuantitativo de Scoring de Fondos Mutuos
          </p>
          <p className="text-sm text-[#5a5a5a] tracking-[0.08em] leading-relaxed text-center max-w-md italic">
            Renta Variable Internacional
          </p>
        </div>
        <p className="text-sm text-[#636363] tracking-[0.2em] uppercase">
